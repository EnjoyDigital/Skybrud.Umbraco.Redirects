angular.module('umbraco').controller('SkybrudUmbracoRedirects.ImportDialog.Controller', function ($rootScope, $scope, $http, notificationsService, skybrudRedirectsService, localizationService, editorService, $timeout) {
